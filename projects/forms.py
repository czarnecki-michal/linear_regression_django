...
class ChartForm(forms.Form):
    workedYears_min = forms.IntegerField(label="worked years min", max_value=50000, min_value=0, initial=0)
    workedYears_max = forms.IntegerField(label="worked years max", max_value=50000, min_value=0, initial=100)
